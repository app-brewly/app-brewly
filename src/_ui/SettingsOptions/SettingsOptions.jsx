...
function SettingsOptions({
    type, // "dual_icon" | "single_icon" | "direct_action" | "toggle" | "language"
    icon_left,
    setting_title,
    toggle__type,
    onArrowClick,
    ...
    const cx = (base) =>
        `${base} ${
            custom_class && styles[custom_class] ? styles[custom_class] : ""
        }`;
    ...
    return (
        <div>
            {type === "dual_icon" && (
                <button
                    type='button'
                    className={cx(styles.setting_row)}
            ...
            {type === "single_icon" && (
                <div className={cx(styles.setting_row)}>
                    <div className={styles.left_icon}>{icon_left}</div>
                    <div className={styles.setting_title}>{setting_title}</div>
                </div>
            )}
